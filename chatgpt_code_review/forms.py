...
from utils import EXTENSION_TO_LANGUAGE_MAP, EXTENSION_TO_LANGUAGE_MAP_DEFAULT
...
class RepoForm:
    ...
    default_options = EXTENSION_TO_LANGUAGE_MAP_DEFAULT.keys()

    def __init__(self, default_repo_url: str):
        self.default_repo_url = default_repo_url
        self.repo_url = ""
        self.api_key = ""
        self.api_url = "https://api.pawan.krd/pai-001/v1"
        self.extensions = []
